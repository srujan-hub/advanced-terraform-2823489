...
# S3 BUCKET
# //////////////////////////////
resource "aws_s3_bucket" "vsk30-tfremotestate" {
...
resource "aws_s3_bucket_public_access_block" "vsk30-tfremotestate" {
  bucket = aws_s3_bucket.vsk30-tfremotestate.id
